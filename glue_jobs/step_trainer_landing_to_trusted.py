...
step_trainer_landing_node1764350423395 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-d609-ne/step_trainer_landing/"], "recurse": True}, transformation_ctx="step_trainer_landing_node1764350423395")
...
'''
SQLQuery_node1764300791119 = sparkSqlQuery(glueContext, query = SqlQuery1921, mapping = {"cust":customer_curated_node1764300771856, "stepdata":step_trainer_landing_node1764350423395}, transformation_ctx = "SQLQuery_node1764300791119")
